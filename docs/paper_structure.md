...
- Method: GRPO with composite reward `R_total = λ·R_fairness - P_structural`
...
> ⚠️ Reward equation in abstract must be updated: old equation was `R_correctness + λ·R_fairness - β·R_hacking`. Current correct equation is `λ·R_fairness - P_structural`.
