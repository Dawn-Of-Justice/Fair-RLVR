...
No single trained model dominates across all OOD benchmarks. On WinoBias, all models show moderate gender-coreference bias (0.20--0.21); GRPO achieves the lowest score (0.200), confirming residual bias reflects pre-training priors rather than anything amplified by fairness training. On StereoSet, GRPO achieves the best LMS (0.962) and ICAT (0.582), indicating stronger language coherence; Fair-RLVR scores slightly lower (ICAT 0.575), a modest trade-off for its stronger BBQ fairness gains. On Intersectional BBQ, Fair-RLVR achieves the highest ambiguous-context accuracy (96.2\%), suggesting the fairness reward generalises to unseen intersectional combinations. Fair-RLVR is the only model that simultaneously achieves low BBQ bias (Table~\ref{tab:main}) and strong intersectional fairness.
